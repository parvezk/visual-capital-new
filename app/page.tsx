    ...
    <main className="relative w-full overflow-hidden selection:bg-[#1E3A5F] selection:text-white">
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start text-left z-10">
            ...
            <p className="font-ibm-plex text-[18px] md:text-[20px] text-[#6B7280] max-w-[45ch] mb-10 leading-relaxed">
              An AI engine that generates context-aware, interactive data visualizations 
              on demand. Not from predefined charts, but composed dynamically by AI that 
          ...
          >
            <img 
              ...
              onError={(e) => {
                ...
                e.currentTarget.className = "w-full h-full object-cover rounded-2xl opacity-20 grayscale";
              }}
            />
          </motion.div>
        </div>
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-ibm-plex text-[18px] md:text-[20px] text-[#6B7280] leading-relaxed">
              Think of it as a Visualization Engine as API, rendered as streaming UI 
              components that any application can embed.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="font-ibm-plex text-[16px] text-[#6B7280] leading-relaxed">
                The AI doesn&apos;t pick a chart type. It determines the right 
                interactive experience for each data signal: sankey diagrams, network 
                graphs, geospatial maps, interactive drill-downs.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="font-ibm-plex text-[16px] text-[#6B7280] leading-relaxed">
                A Visualization Engine as API. Any SaaS product can embed 
                Visual Capital to make their data views intelligent, rendered as streaming 
                React components.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="font-ibm-plex text-[16px] text-[#6B7280] leading-relaxed">
                Every visualization is generated from your data&apos;s shape and 
                the user&apos;s question. No configuration. No predefined templates. 
                Just the right insight.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <footer className="w-full bg-[#FAFAF9] border-t border-[#E5E7EB] py-8 px-6 md:px-12 lg:px-24">
        <div className="w-full max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-ibm-plex text-[14px] text-[#6B7280]">
            © 2025 Visual Capital
          </p>
